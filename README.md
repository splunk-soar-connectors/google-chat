...
This table lists the configuration variables required to operate Google Chat App. These variables are specified when configuring a Google Chat App asset in Splunk SOAR.
